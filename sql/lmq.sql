...
create table tab_privileges (id number, name varchar(255), object_name varchar(255),needtocheck number, constraint pk_tab_privileges primary key (id)); -- 1: column, 0: table
insert into user_manager.tab_privileges values(1, 'SELECT', 'USERS', 1);
insert into user_manager.tab_privileges values(2, 'INSERT', 'USERS', 0);
insert into user_manager.tab_privileges values(3, 'DELETE', 'USERS', 0);
insert into user_manager.tab_privileges values(4, 'UPDATE', 'USERS', 0);

select * from tab_privileges;
